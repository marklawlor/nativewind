...
We want to support and promote universal applications, and as such all platforms are equal. The library should always produce styles in the media that works best on that platform (eg StyleSheet.create on native, CSS StyleSheet on web).
